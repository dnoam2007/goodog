...
class Employee:
    ...
    def calculate_payment(self):
        ...
        z=sum(df['additional charge'].dropna().apply(lambda x: 'ענ"ן' not in str(x)).astype(int))
        payment=x+y+z
...
calculate_employee_payments_for_debug1(r"C:\Users\user\Desktop\תוכנה\app\1.xlsx")
